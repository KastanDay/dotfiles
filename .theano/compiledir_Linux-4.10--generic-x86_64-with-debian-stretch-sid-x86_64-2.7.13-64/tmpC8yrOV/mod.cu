...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_8caca893ab41ad4849afd885dc106b92 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_8caca893ab41ad4849afd885dc106b92() {
        ...
        ~__struct_compiled_op_8caca893ab41ad4849afd885dc106b92(void) {
            cleanup();
        }
...
{
// Op class HostFromGpu

        Py_XDECREF(V1);
        V1 = (PyArrayObject *) CudaNdarray_CreateArrayObj(V3);
        if(!V1){
            {
        __failure = 5;
        if (!PyErr_Occurred()) {
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_8caca893ab41ad4849afd885dc106b92_executor(__struct_compiled_op_8caca893ab41ad4849afd885dc106b92* self) {
            return self->run();
        }

        static void __struct_compiled_op_8caca893ab41ad4849afd885dc106b92_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_8caca893ab41ad4849afd885dc106b92*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_8caca893ab41ad4849afd885dc106b92* struct_ptr = new __struct_compiled_op_8caca893ab41ad4849afd885dc106b92();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_8caca893ab41ad4849afd885dc106b92_executor), struct_ptr, __struct_compiled_op_8caca893ab41ad4849afd885dc106b92_destructor);
  return thunk; }
...
PyMODINIT_FUNC init8caca893ab41ad4849afd885dc106b92(void){
   import_array();
   (void) Py_InitModule("8caca893ab41ad4849afd885dc106b92", MyMethods);
}
